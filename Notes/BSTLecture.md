...
Code stolen from [Paul Bladek of EDCC](http://faculty.edcc.edu//paul.bladek/CS133/bst_h.htm).
...
namespace PB_BST
{
	...
	public:
        ...
        /* a reference to a pointer so we can change what the pointer points to */
	...
	protected:
        ...
        /* Is a ** to manipulate it, useful for deletion */
    ...
    // No return, but sets match reference to result and breaks
	//--------------------------------------------------------------------
	template <class T>
...
// Compiled under MS Visual C++.Net 2013; Windows 7
// by Paul Bladek
// December, 2000
// PB revised April, 2005
// PB revised June, 2015
//--------------------------------------------------------------------
int main(void)
{
	using PB_BST::bst;
